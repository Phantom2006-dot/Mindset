...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-primary/10 to-background">
      ...
      <section className="py-12 md:py-16 bg-background" data-testid="section-what-to-expect">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-6 text-foreground" data-testid="text-what-to-expect-title">
            What to Expect
          </h2>
          
          <div className="space-y-3 text-center">
            <div className="flex items-center justify-center gap-3 text-lg" data-testid="text-feature-0">
              <div className="w-2 h-2 rounded-full bg-accent flex-shrink-0" />
              <p className="text-foreground">Insights and resources on leadership and growth</p>
            </div>
            <div className="flex items-center justify-center gap-3 text-lg" data-testid="text-feature-1">
              <div className="w-2 h-2 rounded-full bg-accent flex-shrink-0" />
              <p className="text-foreground">The 'Mindset Before Skillset' framework</p>
            </div>
            <div className="flex items-center justify-center gap-3 text-lg" data-testid="text-feature-2">
              <div className="w-2 h-2 rounded-full bg-accent flex-shrink-0" />
              <p className="text-foreground">Book updates, launch events, and exclusive community access</p>
            </div>
          </div>
          ...
          <div className="flex justify-center mt-8">
            <Button
              ...
              data-testid="button-what-to-expect-subscribe"
            >
              SUBSCRIBE NOW
            </Button>
          </div>
      ...
      {!hasSubscribed && (
        <section 
          ...
          className={`py-12 md:py-16 bg-gradient-to-br from-primary/20 via-primary/10 to-accent/10 transition-all duration-500 ${
            isFormExiting ? 'opacity-0 scale-95' : 'opacity-100 scale-100'
          }`}
          data-testid="section-join-movement"
        >
          <div className="container mx-auto px-4 max-w-2xl">
            <div className="text-center mb-8">
              <h2 className="text-3xl md:text-4xl font-bold mb-3 text-foreground" data-testid="text-join-title">
                Join the Movement
              </h2>
              <p className="text-base text-muted-foreground max-w-xl mx-auto" data-testid="text-join-description">
            ...
            <div 
              className={`bg-card rounded-2xl shadow-2xl p-6 md:p-8 border border-card-border transition-all duration-700 ${
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                      ...
                      <FormItem>
                        <FormControl>
                          <Input
                            ...
                            className="h-11 text-base border-2 focus:border-primary focus:ring-primary/20 focus:ring-2"
                  ...
                  <Button
                    ...
                    className="w-full bg-gradient-to-r from-accent to-accent/90 hover:from-accent/90 hover:to-accent text-accent-foreground font-semibold h-11 text-base rounded-lg hover:scale-[1.02] transition-transform"
      ...
      {/* Footer */}
      <footer className="bg-gradient-to-br from-primary/90 to-primary text-primary-foreground py-10" data-testid="footer">
        <div className="container mx-auto px-4">
          <div className="text-center mb-6">
            <h3 className="text-2xl md:text-3xl font-bold mb-2" data-testid="text-footer-tagline">
              STAY TUNED, YOUR MINDSET JOURNEY STARTS SOON.
            </h3>
            <p className="text-base opacity-90" data-testid="text-footer-author">
              Oluwasegun Ajibola (Mr Wood) Author, Mindset Before Skillset
            </p>
          </div>

          <div className="flex justify-center gap-6 mb-5">
            <h4 className="text-base font-semibold" data-testid="text-follow-us">Follow Us</h4>
          </div>
